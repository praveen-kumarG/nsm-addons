...
class HonIssue(models.Model):
    ...
    @api.one
    @api.depends('hon_issue_line.invoice_line_id', 'hon_issue_line.employee', 'hon_issue_line.gratis')
    def _invoiced(self):
        flag = True
    ...
    date_publish = fields.Date(related='account_analytic_id.date_publish',
    ...
    hon_issue_line = fields.One2many('hon.issue.line', 'issue_id', 'Hon Lines', readonly=False,
    ...
    def action_invoice_create(self):
        ...
        return self.env['hon.issue.line.make.invoice'].with_context(ctx).make_invoices_from_lines()
